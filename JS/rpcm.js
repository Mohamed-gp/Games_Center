...
let opportunities = document.querySelectorAll(".paper,.scissors,.rock,.lizard,.spock");
...
let mohamedTitle = document.querySelector(
  ...
  if(localStorage.scoreMaster != null){
    result.innerHTML = localStorage.scoreMaster
  }
for (let i = 0; i < opportunities.length; i++) {
  opportunities[i].addEventListener("click", function () {
    ...
    stepOne.children[1].append(
      opportunities[Math.floor(Math.random() * 5)].cloneNode(true)
    );
    ...
    if (
      ...
      (yourChose == "lizard" && mohamedChose == "spock") ||
      (yourChose == "lizard" && mohamedChose == "paper") ||
      (yourChose == "spock" && mohamedChose == "scissors") ||
      (yourChose == "spock" && mohamedChose == "rock") ||
      (yourChose == "scissors" && mohamedChose == "lizard") ||
      (yourChose == "paper" && mohamedChose == "spock") ||
      (yourChose == "rock" && mohamedChose == "scissors")
    ) {
    ...
    //lose
      ...
      (mohamedChose == "lizard" && yourChose == "spock") ||
      (mohamedChose == "lizard" && yourChose == "paper") ||
      (mohamedChose == "spock" && yourChose == "scissors") ||
      (mohamedChose == "spock" && yourChose == "rock") ||
      (mohamedChose == "scissors" && yourChose == "lizard") ||
      (mohamedChose == "paper" && yourChose == "spock") ||
      (mohamedChose == "rock" && yourChose == "scissors")
      ) {
        result.innerHTML = +result.innerHTML - 1;
    ...
    // draw
    // local storage
    localStorage.scoreMaster = +result.innerHTML;
